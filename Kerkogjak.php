    ...
    if( !empty($Emri) && !empty($Mbiemri) )
		{
			...
			$query = "insert into kerkuesit (Emri,Mbiemri,Nrtelefonit,Grupigjakut,Qyteti) values ('$Emri','$Mbiemri','$Nrtelefonit','$Grupigjakut','$Qyteti','$image')";

            if (mysqli_query($con, $query)) {
           
                header("Location:Kerkuesit.php");
                exit();
            } else {
